  ...
  return (
    <html lang="en" className={inter.className}>
      <head>
        ...
        <meta
          name="description"
          content="AFM Derby Ruach is a church that believes in the power of the Holy Spirit and the Bible."
        />
        <meta
          name="keywords"
          content="AFM Derby Ruach Assembly, AFM, Church, Bible, Jesus Christ, Gospel"
        />
        ...
        />
        <meta name="apple-mobile-web-app-title" content="Afm Derby" />
        <link rel="manifest" href="/site.webmanifest" />
        <script
          async
          defer
          src="https://static.cdn.prismic.io/prismic.js?new=true&repo=afmderby"
        ></script>
      </head>
      <body>
