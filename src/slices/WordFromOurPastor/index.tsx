...
const WordFromOurPastor: FC<WordFromOurPastorProps> = ({ slice }) => {
  return (
    <div className="from-afm-blue h-fit overflow-clip bg-linear-180 to-[#0C1E31] px-8 py-40 lg:px-0">
      <Bounded
      ...
      >
        <div className="content">
          <div className="text-6xl font-black tracking-tight text-balance text-white capitalize">
        ...
        <div className="flex items-center [--corner-radius:16px] lg:px-20">
